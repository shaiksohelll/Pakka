...
- `20260516120100_request_account_deletion_idempotent_rollback.sql` - Restore non-idempotent RPC (no FOUND check; repeated calls would re-spam admin notifications).
